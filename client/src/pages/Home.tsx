...
import bannerMercedes from "@assets/generated_images/mercedes_benz_car_dark_banner.png";
import bannerWheels from "@assets/generated_images/custom_forged_wheel_banner.png";
import bannerPromo from "@assets/generated_images/automotive_parts_composition.png";
import extraBanner1 from "@assets/generated_images/dark_workshop_parts_banner.png";
import extraBanner2 from "@assets/generated_images/engine_assembly_banner.png";
import extraBanner3 from "@assets/generated_images/dyno_testing_banner.png";

import insta1 from "@assets/generated_images/car_engine_bay_instagram_shot.png";
import insta2 from "@assets/generated_images/racing_car_on_track_instagram_shot.png";
import insta3 from "@assets/generated_images/mechanic_working_instagram_shot.png";
import insta4 from "@assets/generated_images/car_meet_instagram_shot.png";

export default function Home() {
  const newArrivals = products.filter(p => p.isNew).slice(0, 4);
  const bestSellers = products.filter(p => p.isBestSeller).slice(0, 2); // Only need 2 for "Best Of The Day"
  ...
  return (
    <div className="flex flex-col gap-16 pb-16 bg-background">
      ...
      {/* Featured Categories (Updated Layout) */}
      ...
      <section className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative h-[300px] rounded-lg overflow-hidden group">
            <img src={bannerMercedes} alt="Car and Truck" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
          ...
          <div className="relative h-[300px] rounded-lg overflow-hidden group">
            <img src={bannerWheels} alt="Platform Custom Forged" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex flex-col justify-center px-8">
      ...
      {/* Built For Speed (Restored Section) */}
        ...
        <div className="relative rounded-xl overflow-hidden bg-background border border-border shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative min-h-[400px]">
               ...
               <img src={bannerPromo} alt="Performance Parts" className="absolute inset-0 w-full h-full object-cover object-center z-10" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           <div className="relative h-[250px] rounded-lg overflow-hidden group">
              <img src={extraBanner1} alt="Workshop" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
           ...
           <div className="relative h-[250px] rounded-lg overflow-hidden group">
              <img src={extraBanner2} alt="Engine Build" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-black/60 flex items-end p-6">
                 <div>
           ...
           <div className="relative h-[250px] rounded-lg overflow-hidden group">
              <img src={extraBanner3} alt="Dyno Testing" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-black/60 flex items-end p-6">
                 <div>
      ...
      {/* Blog/News (From previous design, kept at bottom) */}
       <section className="container mx-auto px-4">
        <div className="flex items-center justify-center mb-10">
          <h2 className="text-3xl font-bold font-heading italic uppercase text-foreground relative inline-block">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           {[
             {title: "Turbo Sizing Guide", image: insta1, date: "Oct 15"},
             {title: "Track Day Prep", image: insta2, date: "Oct 12"},
             {title: "Titanium Exhausts", image: insta3, date: "Oct 08"}
           ].map((post, i) => (
