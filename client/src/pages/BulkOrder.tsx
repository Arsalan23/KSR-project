...
import { Plus, Trash2, Upload, ShoppingCart, AlertCircle, CheckCircle2 } from "lucide-react";
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-card border border-border p-6">
        <div className="flex justify-end gap-4 mb-4">
          <Button variant="outline" className="rounded-none border-border hover:border-primary">
          ...
          <Table>
            <TableHeader className="bg-secondary/50">
              <TableRow className="border-border hover:bg-secondary/50">
                ...
                <TableHead className="w-[200px] text-white">SKU</TableHead>
                <TableHead className="text-white">Product Name</TableHead>
                <TableHead className="w-[100px] text-white">Qty</TableHead>
                <TableHead className="w-[100px] text-white">Stock</TableHead>
        ...
        <div className="flex justify-between items-center">
          <Button variant="outline" onClick={addRow} className="rounded-none border-dashed border-border hover:border-primary text-muted-foreground hover:text-white">
