...
export default function OrderTracking() {
  ...
  const orderId = params.orderId || "KSR-9928";
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-muted-foreground mb-8">Order ID: <span className="text-white font-mono">{orderId}</span></p>
              ...
              {steps.map((step, index) => (
                <div key={index} className="relative flex items-start gap-6">
                  ...
                  <div className="flex-1 pt-1">
                    <h3 className={`font-bold font-heading uppercase text-lg ${step.completed ? 'text-white' : 'text-muted-foreground'}`}>
                      {step.title}
                    </h3>
